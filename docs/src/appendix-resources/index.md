...
|---|---|---|---|
| Git Flow | https://nvie.com/posts/a-successful-git-branching-model/ | 大規模開発 | 高 |
| GitHub Flow | https://guides.github.com/introduction/flow/ | 継続的デリバリー | 高 |
| GitLab Flow | https://docs.gitlab.com/ee/topics/gitlab_flow.html | 環境別デプロイ | 中 |
| Forking Workflow | https://www.atlassian.com/git/tutorials/comparing-workflows/forking-workflow | オープンソース開発 | 中 |

### CI/CD・自動化

| ツール・サービス | 用途 | GitHub連携 | 学習コスト |
|---|---|---|---|
| GitHub Actions | CI/CD・自動化 | ネイティブ | 低 |
| Jenkins | 企業向けCI/CD | プラグイン対応 | 高 |
| CircleCI | クラウドCI/CD | 優秀な連携 | 中 |
| Travis CI | オープンソース向け | 伝統的な選択肢 | 中 |
...
|---|---|---|---|
| Visual Studio Code | ★★★★★ | GitLens, GitHub Pull Requests | 大 |
| IntelliJ IDEA | ★★★★☆ | 標準機能が充実 | 中 |
| Atom* | ★★★☆☆ | GitHub製（開発終了） | - |
